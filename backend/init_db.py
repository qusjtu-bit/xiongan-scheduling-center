...
def init_db():
    ...
    with app.app_context():
        ...
        # ========== 9. 数据资源目录（"一个数据一个源头"治理） ==========
        resources = [
            DataResource(code='proj_list', name='城建项目信息', domain=1, source_system='规建管一体化平台',
                         table_name='dc_project', data_type='基础数据', update_freq='每日',
                         owner_dept='城乡发展处', owner_person='周处长', quality_status='良好',
                         record_count=8,
                         description='雄安新区在建和已竣工城建项目基本信息，包含房建、市政、交通、水利等类型。唯一源头：规建管一体化平台项目库，由城乡发展处统筹维护。',
            ...
            DataResource(code='biz_list', name='建筑业企业信息', domain=1, source_system='建筑市场监管平台',
                         table_name='dc_business', data_type='基础数据', update_freq='每日',
                         owner_dept='建筑市场处', owner_person='郑处长', quality_status='良好',
                         record_count=8,
                         description='新区注册建筑业企业基本信息，含资质等级、类别、从业人员。唯一源头：建筑市场监管平台企业库，由建筑市场处负责审核更新。',
            ...
            DataResource(code='bus_station', name='公交站点信息', domain=2, source_system='交通运行监测平台',
                         table_name='dc_bus_station', data_type='基础数据', update_freq='每日',
                         owner_dept='综合交通组', owner_person='褚处长', quality_status='良好',
                         record_count=10,
                         description='雄安新区公交站点分布、途经线路与客流数据。唯一源头：交通运行监测平台，由综合交通组维护更新。',
            ...
            DataResource(code='water_list', name='河湖基本信息', domain=3, source_system='水文监测系统',
                         table_name='dc_water', data_type='基础数据', update_freq='每日',
                         owner_dept='水利组', owner_person='卫处长', quality_status='良好',
                         record_count=6,
                         description='新区主要河湖、水库基础信息与水质水位数据。唯一源头：水文监测系统，由水利组负责更新。',
            ...
            DataResource(code='muni_list', name='市政设施信息', domain=4, source_system='城管综合平台',
                         table_name='dc_municipal', data_type='基础数据', update_freq='每日',
                         owner_dept='城市管理处', owner_person='蒋处长', quality_status='良好',
                         record_count=10,
                         description='市政道路、桥梁、管廊、井盖、路灯等设施分布与运行状态。唯一源头：城管综合平台，由城市管理处负责维护。',
                         fields_schema='[{"name":"设施名称","key":"name"},{"name":"类型","key":"ftype"},{"name":"片区","key":"area"},{"name":"状态","key":"status"}]'),
            DataResource(code='idx_proj', name='城乡建设统计指标', domain=1, source_system='数据中枢（汇总规建管平台+建筑市场平台）',
                         table_name='dc_indicator_data', data_type='指标数据', update_freq='每月',
                         owner_dept='城乡发展处', owner_person='周处长', quality_status='良好',
                         record_count=15,
                         description='在建项目数/施工许可/消防验收/隐患/考勤/绿建/造价/投资等15项核心指标，由城乡发展处每月汇总上报。'),
            DataResource(code='idx_trans', name='交通运输统计指标', domain=2, source_system='数据中枢（汇总交通运行监测平台）',
                         table_name='dc_indicator_data', data_type='指标数据', update_freq='每月',
                         owner_dept='综合交通组', owner_person='褚处长', quality_status='良好',
                         record_count=15,
                         description='路网里程/拥堵指数/公交客流/准点率/事故/新能源车等15项核心指标，由综合交通组每月汇总上报。'),
            DataResource(code='idx_water', name='水利水务统计指标', domain=3, source_system='数据中枢（汇总水文监测系统）',
                         table_name='dc_indicator_data', data_type='指标数据', update_freq='每月',
                         owner_dept='水利组', owner_person='卫处长', quality_status='良好',
                         record_count=13,
                         description='河湖数量/水质达标率/水位/雨量/泵站/供水/污水/防汛等13项核心指标，由水利组每月汇总上报。'),
            DataResource(code='idx_muni', name='城市管理统计指标', domain=4, source_system='数据中枢（汇总城管综合平台）',
                         table_name='dc_indicator_data', data_type='指标数据', update_freq='每月',
                         owner_dept='城市管理处', owner_person='蒋处长', quality_status='良好',
                         record_count=12,
                         description='环卫/市容/路灯/井盖/管廊/供热/燃气/绿地/公园等12项核心指标，由城市管理处每月汇总上报。'),
            DataResource(code='idx_overview', name='全局综合指标', domain=5, source_system='数据中枢（跨领域汇总）',
                         table_name='dc_indicator_data', data_type='指标数据', update_freq='每月',
                         owner_dept='办公室', owner_person='陈主任', quality_status='良好',
                         record_count=8,
                         description='跨领域综合指标：总投资/总里程/总客流/综合达标率等，由办公室统一编制发布。'),
            DataResource(code='cert_rec', name='施工许可证信息', domain=1, source_system='审批中心',
                         table_name='-', data_type='业务数据', update_freq='实时',
                         owner_dept='政务服务处', owner_person='杨处长', quality_status='良好',
                         record_count=0,
                         description='施工许可证发放记录，由政务服务处统一受理审批，实时同步至数据中枢。'),
        ]
        for r in resources:
            db.session.add(r)
        print(f'[数据] 插入 {len(resources)} 条数据资源目录')

        # ========== 10. 标准指标定义（≥55项，四大领域，"一个数据一个源头"治理） ==========
        indicators = [
            # ---- 城乡建设 15项 ----
            Indicator(code='cj01', name='在建项目数', domain=1, unit='个', sort=1, definition='当前在建工程项目总数', calc_expr='COUNT(DISTINCT project_id) FROM dc_project WHERE stage="建设"',
                      source_system='规建管一体化平台', owner_dept='城乡发展处', owner_person='周处长', update_freq='每日'),
            Indicator(code='cj02', name='施工许可发放数', domain=1, unit='件', sort=2, definition='本月发放施工许可证数量', calc_expr='COUNT(*) FROM cert_rec WHERE MONTH=当前月',
                      source_system='审批中心', owner_dept='政务服务处', owner_person='杨处长', update_freq='每日'),
            Indicator(code='cj03', name='消防验收通过率', domain=1, unit='%', sort=3, definition='消防验收通过项目占比', calc_expr='通过数/受理数×100',
                      source_system='审批中心', owner_dept='工程质量安全处', owner_person='李处长', update_freq='每月'),
            ...
            Indicator(code='cj13', name='档案验收完成数', domain=1, unit='件', sort=13, definition='城建档案验收完成项目数', calc_expr='COUNT(*) FROM archive WHERE status="已验收"',
                      source_system='规建管一体化平台', owner_dept='城乡发展处', owner_person='周处长', update_freq='每月'),
            ...
            Indicator(code='jt01', name='路网总里程', domain=2, unit='km', sort=1, definition='新区路网总里程（含在建）', calc_expr='SUM(length) FROM road',
                      source_system='交通运行监测平台', owner_dept='综合交通组', owner_person='褚处长', update_freq='每月'),
            Indicator(code='jt02', name='拥堵指数', domain=2, unit='-', sort=2, definition='主要路段交通拥堵综合评价指数', calc_expr='AVG(congestion_index) FROM road_section',
                      source_system='交通运行监测平台', owner_dept='综合交通组', owner_person='褚处长', update_freq='实时'),
            ...
            Indicator(code='jt04', name='公交站点覆盖率', domain=2, unit='%', sort=4, definition='500米公交站点覆盖面积比例', calc_expr='覆盖面积/建成区总面积×100',
                      source_system='交通运行监测平台', owner_dept='综合交通组', owner_person='褚处长', update_freq='每季度'),
            ...
            Indicator(code='jt12', name='港口岸线利用率', domain=2, unit='%', sort=12, definition='港口岸线已利用长度占比', calc_expr='已利用/总岸线×100',
                      source_system='交通运政系统', owner_dept='综合交通组', owner_person='褚处长', update_freq='每季度'),
            ...
            Indicator(code='sl01', name='河湖数量', domain=3, unit='条/个', sort=1, definition='新区主要河湖水库总数量', calc_expr='COUNT(DISTINCT name) FROM dc_water',
                      source_system='水文监测系统', owner_dept='水利组', owner_person='卫处长', update_freq='每月'),
            ...
            Indicator(code='sl03', name='河湖长巡查次数', domain=3, unit='次', sort=3, definition='月度河湖长巡查总次数', calc_expr='COUNT(*) FROM patrol_record',
                      source_system='河湖长制管理系统', owner_dept='水利组', owner_person='卫处长', update_freq='每月'),
            Indicator(code='sl04', name='水位超警次数', domain=3, unit='次', sort=4, definition='水位超警戒线事件次数', calc_expr='COUNT(*) FROM water_alarm',
                      source_system='水文监测系统', owner_dept='水利组', owner_person='卫处长', update_freq='实时'),
            ...
            Indicator(code='sl12', name='水土流失治理率', domain=3, unit='%', sort=12, definition='水土流失已治理面积占比', calc_expr='已治理/流失总面积×100',
                      source_system='水利监测平台', owner_dept='水利组', owner_person='卫处长', update_freq='每季度'),
            Indicator(code='sl13', name='防汛物资储备率', domain=3, unit='%', sort=13, definition='防汛物资实际储备与计划比例', calc_expr='实际/计划×100',
                      source_system='防汛抗旱指挥系统', owner_dept='水利组', owner_person='卫处长', update_freq='每月'),
            ...
            Indicator(code='cg03', name='日均清运量', domain=4, unit='吨', sort=3, definition='生活垃圾日均清运量', calc_expr='AVG(daily_volume) FROM waste_transport',
                      source_system='城管综合平台', owner_dept='城市管理处', owner_person='蒋处长', update_freq='每日'),
            ...
            Indicator(code='cg09', name='供热管网覆盖率', domain=4, unit='%', sort=9, definition='集中供热管网覆盖面积比例', calc_expr='覆盖面积/建成区×100',
                      source_system='城管综合平台', owner_dept='城市管理处', owner_person='蒋处长', update_freq='每季度'),
            Indicator(code='cg10', name='燃气监测异常数', domain=4, unit='次', sort=10, definition='燃气管网监测异常事件次数', calc_expr='COUNT(*) FROM gas_alarm WHERE MONTH=当前月',
                      source_system='城管综合平台', owner_dept='城市管理处', owner_person='蒋处长', update_freq='实时'),
